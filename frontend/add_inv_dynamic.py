...
new_translations = {
    'investigations': {'Kannada': 'ತನಿಖೆಗಳು', 'Hindi': 'जांचें', 'Tamil': 'விசாரணைகள்', 'Telugu': 'దర్యాప్తులు'},
    'Viewing': {'Kannada': 'ವೀಕ್ಷಿಸುತ್ತಿರುವ', 'Hindi': 'देख रहे हैं', 'Tamil': 'பார்க்கிறது', 'Telugu': 'చూస్తున్నారు'},
}
