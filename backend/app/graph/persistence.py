...
class GraphPersistence:
    ...
    async def save_edge(self, source_id: str, target_id: str, relation: str, properties: dict = None):
        existing = (await self.db.execute(
    ...
    async def get_latest_version(self) -> Optional[Dict]:
        ...
        if v:
            return {"version": v.version, "node_count": v.node_count, "edge_count": v.edge_count}
        return None
