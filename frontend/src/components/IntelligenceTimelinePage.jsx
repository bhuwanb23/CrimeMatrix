        ...
        <div className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 rounded-2xl p-6 text-white shadow-lg shadow-orange-500/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">{t('Intelligence Timeline')}</h1>
                <p className="text-white/80 text-sm mt-0.5">{t('Complete audit trail of AI-generated intelligence')}</p>
              </div>
            </div>
