...
|--------|------|----------|--------|------|-------|
| PASS | A | `GET /docs` | 200 | 0.3s |  |
| PASS | A | `GET /health` | 200 | 0.2s |  |
| PASS | A | `GET /models` | 200 | 0.2s |  |
...
| PASS | A | `GET /workflows` | 200 | 0.6s |  |
| PASS | B | `GET /workflows/investigation` | 200 | 0.1s |  |
| PASS | B | `GET /workflows/investigation/steps` | 200 | 0.1s |  |
| PASS | A | `POST /chat` | 200 | 1.2s |  |
| PASS | A | `POST /tools/invoke:calculator` | 200 | 0.1s |  |
| PASS | B | `GET /memory/sessions/full-validate/history` | 200 | 0.1s |  |
| PASS | B | `GET /memory/sessions/full-validate/summary` | 200 | 0.1s |  |
| PASS | B | `GET /memory/preferences/validate-user` | 200 | 0.1s |  |
| PASS | B | `PUT /memory/preferences/validate-user` | 200 | 0.2s |  |
| PASS | B | `GET /memory/working` | 200 | 0.1s |  |
| BLOCK | C | `POST /memory/investigation` | 200 | 0.1s | expected (needs backend) |
| PASS | B | `DELETE /sessions/full-validate-del` | 200 | 0.6s |  |
| PASS | B | `GET /sessions/full-validate/trace` | 200 | 0.1s |  |
| PASS | C | `POST /rag/index` | 200 | 0.2s |  |
| PASS | B | `POST /rag/search` | 200 | 0.1s |  |
| PASS | B | `GET /rag/stats` | 200 | 0.1s |  |
| PASS | B | `GET /rag/citations/full-validate` | 200 | 0.1s |  |
| PASS | B | `POST /search/expand` | 200 | 3.4s |  |
| PASS | B | `POST /search/rewrite` | 200 | 1.0s |  |
| PASS | B | `POST /search/rerank` | 200 | 0.2s |  |
| PASS | B | `POST /search/intelligent` | 200 | 0.1s |  |
| PASS | C | `POST /search/similar` | 200 | 0.2s |  |
| PASS | C | `POST /search/cross-district` | 200 | 0.2s |  |
...
| PASS | B | `POST /knowledge/network` | 200 | 0.1s |  |
...
| PASS | B | `POST /reasoning/analyze` | 200 | 3.5s |  |
| PASS | B | `POST /reasoning/explain` | 200 | 2.7s |  |
| PASS | B | `POST /predict/forecast` | 200 | 0.1s |  |
| PASS | B | `POST /predict/hotspots` | 200 | 0.1s |  |
| PASS | B | `POST /predict/recidivism` | 200 | 0.3s |  |
| PASS | B | `POST /predict/risk` | 200 | 0.1s |  |
| PASS | B | `POST /predict/mo-similarity` | 200 | 0.2s |  |
...
| PASS | B | `GET /monitor/tools` | 200 | 0.2s |  |
| PASS | B | `GET /monitor/accuracy` | 200 | 0.1s |  |
...
| PASS | C | `POST /tools/invoke:crime_search` | 200 | 0.1s |  |
| PASS | C | `POST /tools/invoke:similar_cases` | 200 | 0.1s |  |
